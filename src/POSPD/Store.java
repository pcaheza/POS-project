...
/**
 * Store is the retail outlet that sells to the customers, employs the cashiers
 * and owns the items. The system shall provide a way to update store
 * information.
 */
public class Store {
	...
	private String name;
	/**
	 * Register is the device that the cashier uses to execute a sales transaction
	 * with the customer.
	 */
	...
	/**
	 * Session attribute represents the period of time the cashier is using a
	 * register to make a sale. The system shall create sessions.
	 */
	...
	/**
	 * default constructor is a constructor which will be called with no arguments
	...
	/**
	 * it is a constructor that we will pass in name and number of store as
	 * parameter.
	 * 
	 * @param number
	 * @param name
	...
	/**
	 * addupc is function for enable items to be sold ,reordered and tracked through
	 * store, this function will add UPC in Store.
	 * 
	 * @param upc
	 */
	...
	/**
	 * this function will add register and register will rings up sales in
	 * store,processes payments, and tracks all of sales item,inventory and customer
	 * or person data with in store.
	 * 
	 * @param register
	 */
	...
	/**
	 * this method will add taxCategory in store.taxCategory will allow to group and
	 * manage similar items tax rates and not all item has the same tax rate.
	 * 
	 * @param taxCategory
	 */
	...
	/**
	 * this method will addSession, session represents the period of time the
	 * cashier is using a register to make a sale of item.
	 * 
	 * @param session
	 */
	...
	public Item findItemForUPC(String upc) {
		UPC upcObj=upcs.get(upc);
		return upcObj.getItem();
	}
